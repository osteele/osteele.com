...
fast-preview.php allows you to preview files that you edit on your
...
- Add this line to your .htaccess, after RewriteEngine On:
    RewriteRule ^(preview/.*)$ wp/fast-preview.php?file=$1 [QSA]
...
Offline usage:
The 'offline' query parameter tells fast-preview not to connect to the
...
include the query parameter:
  RewriteRule ^(preview/.*)$ wp/fast-preview.php?file=$1&offline [QSA]

In offline mode, fast-preview can't query the WP database for the list
...
in the same directory as fast-preview.php.  Each line of this file is
