...
export const products: Product[] = [
	{
		title: "Apple Dylan",
		description: "A programming language based on Common Lisp and Smalltalk, developed at Apple Cambridge.",
...
I wrote the initial version of the server software, that mediated remote control (via separately-developed Web, iPhone, and Android apps), collected logs, and delivered OTA updates; then managed the internet services team that replaced this; then managed technical operations that kept this working in the cloud.`,
	...
	{
		title: "QuickDraw GX",
		description: "An early-90s 2D graphics and geometry library for the Macintosh System 7.",
...
I implemented the geometry engine, including boolean operations (union, intersection, difference) on arbitrary shapes; and wrote the manual for the geometry portion of the API.`,
	},
	{
		...
		description: "An XML-based platform for writing Rich Internet Applications (2000-2010).",
		href: "/products/laszlo-presentation-server",
		year: "2002-2007",
		thumbnail: "https://images.osteele.com/products/laszlo-presentation-server.webp",
...
This was my first commercial software product, written in 6502 assembly language when I was in high school.`,
	...
	{
		title: "BrowseGoods",
		description: "A visual Amazon catalog browser using novel display algorithms (2007).",
...
The application was built using the OpenLaszlo platform and integrated with Amazon's web services.`,
	...
	{
		title: "StyleCart",
		description: "A visual shopping cart with drag-and-drop paper doll arrangement (2007).",
...
The application was built using OpenLaszlo and integrated with multiple e-commerce platforms.`,
	},
	{
		...
		description: "An early web-based calendar with iCalendar/WebDAV integration (2008).",
		href: "/products/laszlo-webtop-calendar",
		year: "2008",
		thumbnail: "https://images.osteele.com/products/laszlo-webtop-calendar.avif",
		role: "Architect",
...
export const getProductSlugs = (): string[] => {
	return products
		.map((product) => {
			// Extract the slug from the href (e.g., /products/apple-dylan -> apple-dylan)
			const match = product.href.match(/\/products\/(.+)/);
