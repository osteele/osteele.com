    ...
    <PageLayout title="Teaching">
      <Tabs defaultValue={tab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-8">
          <TabsTrigger asChild value="teaching">
            <Link href="/education">Courses</Link>
          </TabsTrigger>
          <TabsTrigger asChild value="materials">
            <Link href="/teaching-materials">Educational Materials</Link>
          </TabsTrigger>
        </TabsList>
