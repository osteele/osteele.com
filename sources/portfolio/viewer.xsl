...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <body>
        ...
        <div class="references">
          ...
          <xsl:if test="//include/@href">
            <h3>Includes</h3>
            <ul class="nl">
              <xsl:for-each select="//include[starts-with(@href, 'incubator')=false]/@href">
  ...
  <xsl:template mode="attribute-value" match="include[starts-with(@href, 'incubator')=false]/@href">
    <a href="{.}"><xsl:value-of select="."/></a>
  </xsl:template>
  
  <xsl:template mode="attribute-value" match="script/@src">
    <a href="{.}"><xsl:value-of select="."/></a>
  </xsl:template>
