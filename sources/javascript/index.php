...
<dl>
  ...
  <dd>Measure and subdivide beziers, and animate points along a path composed of single or multiple beziers.  <a href="/sources/javascript/bezier.js">bezier.js</a>, <a href="/sources/javascript/path.js">path.js</a>, <a href="/sources/javascript/bezier-demo.html">demo</a>, <a href="/archives/2006/02/javascript-beziers">blog</a>.  (There's also an <a href="/sources/openlaszlo">OpenLaszlo version</a>.)</dd>
  
  <dt>TextCanvas library</dt>
  <dd>TextCanvas is a wrapper for the WHATWG <tt>canvas</tt> element, that adds a <tt>drawString</tt> method for labeling graphs.  <a href="/sources/javascript/textcanvas.js">Source</a>, <a href="/sources/javascript/docs/textcanvas">docs</a>, <a href="/sources/javascript/textcanvas-example.html">demo</a>.  (There's also an <a href="/sources/openlaszlo">OpenLaszlo version</a>.)</dd>
