...
Functional.invoke = function(methodName) {
...
Functional.I = function(x) {
    return x
};
Functional.K = function(x) {
    return function() {
        return x
    }
};
