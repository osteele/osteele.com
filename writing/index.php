...
<div id="container">
	...
	<div id="main">
		<div id="menusystem">
			<div id="navcontainer">
				<ul><li><a href="../" rel="self">Home</a></li><li><a href="../about/" rel="self">About</a></li><li><a href="../projects/overview.php" rel="self">Projects</a></li><li><a href="/projects/" rel="self">Portfolio</a></li><li><a href="./" rel="self" id="current">Writing</a><ul><li><a href="../writing/writing/javascript.php" rel="self">JavaScript</a></li><li><a href="../writing/writing/presentations.php" rel="self">Presentations</a></li><li><a href="/blog/" rel="self">Blog</a></li></ul></li><li><a href="../contact/" rel="self">Contact</a></li></ul>
			</div>
