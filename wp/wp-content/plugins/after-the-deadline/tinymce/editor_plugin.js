...
(function() 
{
   ...
   tinymce.create('tinymce.plugins.AfterTheDeadlinePlugin', 
   {
      ...
      init : function(ed, url) 
      {
         ...
         editor.addCommand('mceWritingImprovementTool', function() 
         {
            ...
            plugin.sendRequest('checkDocument', ed.getContent({ format: 'raw' }), function(data, request, someObject)
            {
               ...
               {
                  ed.windowManager.alert('There was a problem communicating with the After the Deadline service. Try again in one minute.');
                  return;
               }
