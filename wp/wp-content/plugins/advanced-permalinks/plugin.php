...
if (!class_exists ('Widget'))
{
	class Widget
	{
		...
		function initialize ()
		{
			...
			if (!function_exists ('wp_register_sidebar_widget') && function_exists ('register_sidebar_widget'))
			{
			...
			if (!function_exists ('wp_register_widget_control') && function_exists ('register_widget_control'))
			{
