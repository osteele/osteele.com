 ...
 */
 ...
 function latex_content($text) {
    ...
    $latexrender_path = "/home/osteele/osteele.com/wp/wp-content/plugins/latexrender";
	...
	//	$latex_formula = str_replace("</P>","",$latex_formula);
        ...
        // offset: add vertical alignment in $style_css
            $text = substr_replace($text, "<img src='".$url."' title='".$alt_latex_formula."' alt='".$alt_latex_formula."' $style_css>",$pos,strlen($tex_matches[0][$i]));
        } else {
