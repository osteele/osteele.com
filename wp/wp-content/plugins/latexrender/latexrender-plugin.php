...
function addlatex($latextext) {
	include_once('/home/osteele/osteele.com/wp/wp-content/plugins/latexrender/latex.php');
...
// if you want LaTeX in comments (but beware of spammers) then remove // from the next line
