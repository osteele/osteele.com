...
class sk2_anubis_plugin extends sk2_plugin
{
	...
	var $author = "";
	var $plugin_help_url = "http://wp-plugins.net/wiki/index.php/SK2_Anubis_Plugin";
	var $treatment = true;
	...
	function treat_this(&$cmt_object)
	{
		...
		{
			$this->log_msg( ucfirst($cmt_object->type) . " (ID: $cmt_object->ID) sent to: <b>$treatment</b> (Karma: $cmt_object->karma)." , 3);
