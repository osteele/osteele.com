...
<div class="wrap"> 
	...
	<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>"> 
		<fieldset class="options">
			...
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				 <tr valign="top">
					...
					<td align="left"><input type="text" name="email_smtp_name" value="<?php echo $emai_smtp['username']; ?>" size="30" /></td>
				</tr>
				<tr valign="top">
					<th align="left" width="20%"><?php _e('SMTP Password:', 'wp-email'); ?></th>
					<td align="left"><input type="password" name="email_smtp_password" value="<?php echo $emai_smtp['password']; ?>" size="30" /></td>
				</tr>
				<tr valign="top">
					<th align="left" width="20%"><?php _e('SMTP Server:', 'wp-email'); ?></th>
					<td align="left"><input type="text" name="email_smtp_server" value="<?php echo $emai_smtp['server']; ?>" size="30" /><br /><?php _e('You may leave the above fields blank if you do not use a SMTP server.', 'wp-email'); ?></td>
				</tr>
			</table>
		</fieldset>
		<?php ?>
		<fieldset class="options">
			<legend><?php _e('E-Mail Styles', 'wp-email'); ?></legend>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Text Link For Post', 'wp-email'); ?></th>
					<td align="left">
						<input type="text" name="email_post_text" value="<?php echo stripslashes($email_options['post_text']); ?>" size="30" />
					</td>
				</tr>
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Text Link For Page', 'wp-email'); ?></th>
					<td align="left">
						<input type="text" name="email_page_text" value="<?php echo stripslashes($email_options['page_text']); ?>" size="30" />
					</td>
				</tr>
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Icon', 'wp-email'); ?></th>
					<td align="left">
						<?php
				...
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Link Type', 'wp-email'); ?></th>
					<td align="left">
				...
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Text Link Style', 'wp-email'); ?></th>
					<td align="left">
		...
		<fieldset class="options">
			<legend><?php _e('E-Mail Settings', 'wp-email'); ?></legend>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				<tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Fields:', 'wp-email'); ?></th>
					 <td align="left">
				 ...
				 <tr valign="top">
					<th align="left" width="30%"><?php _e('E-Mail Content Type:', 'wp-email'); ?></th>
					 <td align="left">
				...
				<tr valign="top"> 
					<th align="left" width="30%"><?php _e('No. Of Words Before Cutting Off:', 'wp-email'); ?></th>
					<td align="left"><input type="text" id="email_snippet" name="email_snippet" value="<?php echo  get_option('email_snippet'); ?>" size="5" maxlength="5" /><br /><?php _e('Setting this value more than 0 will enable the snippet feature. This feature will allow you to send a portion (defined by the text field above) of the article to your friend instead of the whole article.', 'wp-email'); ?></td> 
				</tr>
				<tr valign="top"> 
					<th align="left" width="30%"><?php _e('Interval Between E-Mails:', 'wp-email'); ?></th>
					<td align="left"><input type="text" id="email_interval" name="email_interval" value="<?php echo  get_option('email_interval'); ?>" size="5" maxlength="5" /> <?php _e('Mins', 'wp-email'); ?><br /><?php _e('It allows you to specify the interval in minutes between each email sent per user based on IP to prevent spam and flood.', 'wp-email'); ?></td> 
				</tr>
				<tr valign="top"> 
						<th align="left" width="30%"><?php _e('Max Number Of Multiple E-Mails:', 'wp-email'); ?></th>
						<td align="left"><input type="text" id="email_multiple" name="email_multiple" value="<?php echo  get_option('email_multiple'); ?>" size="5" maxlength="3" /><br /><?php _e('Setting this value more than 1 will enable this feature. It allows the maximum number of multiple e-mails that can be send at one go.', 'wp-email'); ?></td> 
				</tr> 
				<tr valign="top"> 
					<th align="left" width="30%"><?php _e('Enable Image Verification:', 'wp-email'); ?></th>
					<td align="left">
		...
		<fieldset class="options">
			<legend><?php _e('Template Variables', 'wp-email'); ?></legend>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				<tr>
	...
	<fieldset class="options">
		...
		<fieldset class="options">
			<legend><?php _e('After Sending E-Mail Templates', 'wp-email'); ?></legend>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				 <tr valign="top">
					<td align="left" width="30%">
		...
		<fieldset class="options">
			<legend><?php _e('E-Mail Misc Templates', 'wp-email'); ?></legend>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3">
				 <tr valign="top">
					<td align="left" width="30%">
