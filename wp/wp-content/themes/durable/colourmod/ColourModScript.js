...
function pickcolor(cssclass, csselement, csscookie, cssform, link, adjX, adjY) {
	...
	function selectmouse(e) {
			...
			if (checkIt('safari')) {
				dotX = mouseX - 24 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				dotY = mouseY - 53 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
				//alert (mouseY+":"+53+":"+document.getElementById('ColourMod').offsetTop+":"+scrollOffset['y']);
				//alert (dotX+":"+dotY);
				sliderX = mouseX - 185 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				sliderY = mouseY - 52 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
			} else {

				dotX = mouseX - 24 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				dotY = mouseY - 53 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
				//alert(mouseY - 53 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100);
				//alert (mouseY+":"+53+":"+document.getElementById('ColourMod').offsetTop+":"+scrollOffset['y']);
				//alert (dotX+":"+dotY);
				sliderX = mouseX - 185 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				sliderY = mouseY - 52 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
	...
	function dragSV(e) {
		if (isdrag) {
			...
			if (!scrollOffset['x'])
				scrollOffset['x'] = 0;
			if (checkIt('safari')) {
				xlimit = mouseX - 24 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				ylimit = mouseY - 53 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
			} else {
				xlimit = mouseX - 24 - replaceString(document.getElementById('colourControl').style.left,'px','') - 340;
				ylimit = mouseY - 53 - replaceString(document.getElementById('colourControl').style.top,'px','') - 100;
				}
