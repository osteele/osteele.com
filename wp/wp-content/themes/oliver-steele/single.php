...
<div class="utwtags">Tags: <?php UTW_ShowTagsForCurrentPost("iconlist") ?></div>
<div class="utwrelposts">Related posts: <?php UTW_ShowRelatedPostsForCurrentPost("postcommalist") ?></div>
